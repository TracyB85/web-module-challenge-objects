...
function createMenuItem(name, price, category){
  const addTaco = { name, price, category };
  return addTaco
...
*/
console.log(createMenuItem('prime rib', 15, 'Lunch'))
console.log(createMenuItem('tuna salad', 10, 'Lunch'))
console.log(createMenuItem('shrimp skewer', 12, 'Lunch'))
...
export const burger = {
  ...
  discount: function(person){
    if (person === 'teacher' || person === 'student'){
      const discountOff = this.price * .25;
      return this.price - discountOff;
    }
    else {
      const discountOff = this.price * .10;
      return this.price - discountOff
    }
  } 
...
*/
console.log(reviews)
reviews.push({name: "Tracy", rating: 5, feedback: "javascript is ridiculously hard"})
console.log(reviews)
